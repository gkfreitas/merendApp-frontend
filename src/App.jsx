...
export default function App() {
  ...
  return (
    <>
      ...
      <main>
        <section ref={homeRef} className="home-bg">
          <div className="home-container">
            <div className="home-cards-container">
              ...
              />
              <div className="home-card-info home-card">
                <div className="home-card-info-data">
                  <img
                    src={appleIcon}
                ...
                <div className="home-card-sub-info">
                  <p>Refeiçoes entregues</p>
                  <span
            ...
            <div className="main-sub-container">
              <div className="main-sub-left-part">
                <h1>Tecnologia que alimenta o futuro da educação</h1>
                <p>
                  Com o merendApp, a gestão da alimentação escolar se torna mais
                  eficiente, econômica e inteligente.
                </p>
                <div className="main-sub-buttons-container">
                  <button
                  ...
                  <button
                    className="main-sub-button-secondary"
                    onClick={() => goToSection(contactRef)}
                  >
                    Teste agora
                    <img
        ...
        <section ref={aboutRef}>
          <div className="about-us-container">
            <img src={bigLogo} alt="Logo da merendApp grande" />
            <div className="about-us-info-container">
              <h2>Sobre nós</h2>
              <p>
                No MerendApp, unimos tecnologia e propósito social para
                transformar a forma como instituições de ensino se conectam com
                fornecedores de alimentos. Criamos uma plataforma que promove
                transparência, agilidade e qualidade em cada etapa da alimentação
                escolar.
                <br />
                <br />
                Trabalhamos para garantir que estudantes recebam refeições mais
                nutritivas, enquanto escolas e fornecedores economizam tempo,
                reduzem desperdícios e fortalecem parcerias sustentáveis.
              </p>
              <div className="about-us-info-with-icon-container">
                <div>
                  <div className="about-us-icon-with-text">
                    <img src={leaf} alt="" />
                    <p>
                  ...
                  <p className="about-us-icon-with-text-subtitle">
                    Tecnologia que simplifica processos e potencializa o alcance
                    da merenda escolar.
                  </p>
                </div>
                <div>
                  ...
                  <p className="about-us-icon-with-text-subtitle">
                    Da cotação à entrega, o MerendApp automatiza processos e reduz
                    desperdícios logísticos.
                  </p>
                </div>
              </div>
          ...
          <div className="about-us-container-cards-wrapper">
            <div className="about-us-container-cards">
      ...
      <div className="container">
        <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-2 border-top">
